...
//
//	
//	this->local_weapon = g_LocalPlayer->m_hActiveWeapon();
...
//		return;
//
//	if (local_weapon->m_flNextPrimaryAttack() > this->cur_time)
//		return;
//
...
//	if (/*g_LocalPlayer->m_hActiveWeapon()->IsWeaponNonAim() ||*/ g_LocalPlayer->m_hActiveWeapon().Get()->HasBullets())
//		return;
//
//	TargetEntities();
//
